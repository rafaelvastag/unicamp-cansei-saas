...
import com.unicamp.inf332.cansei.application.services.exceptions.DataIntegrityException;
...
public class ClienteService {
	...
	public int findPontosDeCarbonoBy(Integer id) {
	...
	public Cliente fromDTO(ClienteDTO objDto) {
		return new Cliente(objDto.getId(), objDto.getNome(), objDto.getEmail(), null, null, null, 0);
	}

	public Cliente fromDTO(ClienteNewDTO objDto) {
		Cliente cli = new Cliente(null, objDto.getNome(), objDto.getEmail(), objDto.getCpfOuCnpj(),
				TipoCliente.toEnum(objDto.getTipo()), pe.encode(objDto.getSenha()), objDto.getPontos());
